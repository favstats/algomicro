...
+ Minor point: Introduction includes (detailed) results
    + maybe could be more general
...
+ Use Case application (UK and Germany):
    ...
    + maybe: "Embedding Regression: Models for Context-Specific Description and Inference"
